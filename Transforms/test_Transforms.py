...
to run:  ./test_Transforms.sh
verbose: ./test_Transforms.sh -v
filter:  ./test_Transforms.sh EquatorialHorizon.test_sirius_2015_01_01T12_00_00
debug:   ./pylaunch.sh -m pdb test_Transforms.py

(Pdb) n
> /Users/lrm/src/Astronomy/Transforms/test_Transforms.py(16)<module>()
-> import Transforms
(Pdb) n
> /Users/lrm/src/Astronomy/Transforms/test_Transforms.py(18)<module>()
-> class TransformTests(unittest.TestCase):
(Pdb) b Transforms.EquatorialHorizon.toHorizon
Breakpoint 1 at /Users/lrm/src/Astronomy/Transforms/Transforms.py:457
